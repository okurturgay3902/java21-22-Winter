...
public class TirRunner {
	...
	public static void main(String[] args) {
		// Bir tane tum ozellikleri degistiren construktor olusturalim
		...
		// uc ozelligi degistiren bir construktor olusturalim
		// int km, String model, String renk

		Tir tir2 = new Tir(12000, "kargo", "turkuaz");

		System.out.println(tir2.km + " " + tir2.model + " " + tir2.renk + " " + tir2.yil + " " + tir2.satilikMi);
		// 12000 kargo turkuaz 2000 false
