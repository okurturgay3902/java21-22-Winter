...
public class C01_Contains {
	...
	public static void main(String[] args) {
		...
		/* verilen bir array de tekrar eden elementleri sadece
		 * birartane yazarak unique elementlerden olusan bir 
		 * array haline getirelim
		 */

		int arr[]= {2,3,4,5,3,6,2,5,3,7,4,8,5,9,1,0,3,5,45};
		
		// 2,3,4,5,6,7,8,9,1,0,45 hale getirecegiz
		...
		System.out.println("tekrarsiz array :"+ Arrays.toString(tekrarsizArray)); //[2, 3, 4, 5, 6, 7, 8, 9, 1, 0, 45]
