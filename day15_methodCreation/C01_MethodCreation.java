...
public class C01_MethodCreation {
	...
	public static void main(String[] args) {
		// kullanicidan adini ve soyismini isteyin
		// iki farkli metod olusturun, metodlardan biri girilen kelimeleri
	...
	// isimGizli(isim,soyisim); bunu metodu olusturmak icin yazmistik sildik
	// acikIsim(isim,soyisim); bunu metodu olusturmak icin yazmistik sildik
